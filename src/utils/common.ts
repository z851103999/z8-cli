...
// 将json数据的属性排一下序
export default function sortDependencies(packageJson: { [x: string]: { [x: string]: any } }) {
  const sorted: any = {}
 ...
 */
export function deepMerge(target: { [x: string]: any }, obj: { [x: string]: any }) {
 ...
 */
export const currentPackageJson = require(path.join(__dirname, '../../package.json'))
